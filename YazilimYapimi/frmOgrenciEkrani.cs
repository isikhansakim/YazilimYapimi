...
namespace YazilimYapimi
{
    public partial class frmOgrenciEkrani : Form
    {
        ...
        {
            int[] dizi = { Sistem.birdogrudansonraki, Sistem.ikidogrudansonraki, Sistem.ucdogrudansonraki, Sistem.dortdogrudansonraki, Sistem.besdogrudansonraki, Sistem.altidogrudansonraki};
